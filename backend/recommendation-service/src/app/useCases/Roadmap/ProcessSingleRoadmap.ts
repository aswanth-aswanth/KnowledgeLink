// src/app/useCases/Roadmap/ProcessSingleRoadmap.ts
...
export default class ProcessSingleRoadmap {
    ...
    public async execute(roadmapId: string): Promise<void> {
        try {
            ...
            if (error instanceof Error) {
                throw new Error("Failed to process roadmap and extract data: " + error.message);
            }
            throw new Error("Unknown error occurred while processing roadmap");
        }
    }
