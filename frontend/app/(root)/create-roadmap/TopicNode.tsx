      ...
      <div className="flex items-center justify-between group w-full overflow-x-auto">
        ...
        <div className="flex items-center flex-shrink-0 ml-1">
          ...
          <button
            ...
            className="p-1 rounded-md focus:outline-none text-gray-400 bg-gray-100 hover:bg-gray-200 dark:text-gray-500 dark:bg-gray-800 dark:hover:bg-gray-700 transition-opacity duration-200"
            title="Add subtopic"
          >
            <Plus size={14} />
          </button>
          <button
            ...
            className="p-1 rounded-md focus:outline-none ml-1 text-gray-400 bg-gray-100 hover:bg-gray-200 dark:text-gray-500 dark:bg-gray-800 dark:hover:bg-gray-700 transition-opacity duration-200"
            title="Delete topic"
          >
            <Trash size={14} />
          </button>
      ...
      {topic.isExpanded && (
        <div className="ml-2 sm:ml-6 mt-2">
          <div
            ...
            className="h-min p-2 mb-2 rounded-md focus:outline-none transition-all duration-200 prose font-medium prose-sm text-base tracking-wider leading-9 max-w-none bg-gray-50 text-gray-600 dark:bg-gray-800 dark:text-gray-300"
          />
          <DropdownMenu open={showStyleMenu} onOpenChange={setShowStyleMenu}>
            <DropdownMenuTrigger asChild>
              <button className="text-sm focus:outline-none text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                Format
              </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-56 m-3 shadow-lg rounded-md border bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
              {TEXT_STYLES.map((style) => (
                <DropdownMenuItem
                  key={style.style}
                  onClick={() => applyStyle(style.style, style.class)}
                  className="cursor-pointer px-4 py-2 text-sm hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
                >
